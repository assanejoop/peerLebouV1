...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  menuItems: MenuItem[] = [
    ...
    { 
      ...
      label: 'Utilisateurs', 
      icon: 'users',
      requiredRoles: ['SUPER_ADMINISTRATOR', 'MAIN_ADMINISTRATOR'],
    ...
    { 
      ...
      label: 'Actualités', 
      icon: 'news',
      requiredRoles: ['SUPER_ADMINISTRATOR', 'MAIN_ADMINISTRATOR', 'CONTENT_ADMINISTRATOR', 'ADMIN'],
    ...
    { 
      ...
      label: 'Opportunités', 
      icon: 'opportunities',
      requiredRoles: ['SUPER_ADMINISTRATOR', 'MAIN_ADMINISTRATOR', 'CONTENT_ADMINISTRATOR'],
      requiredLevel: 3 // Gestion de contenu
    },
    { 
      path: '/full-video', 
